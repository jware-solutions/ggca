...
class CorrelationMethod(Enum):
	"""Correlation method. Spearman, Kendall or Pearson."""
	SPEARMAN = 1
	KENDALL = 2
	PEARSON = 3
...
class AdjustmentMethod(Enum):
	"""P-value adjustment method. Benjamini-Hochberg, Benjamini-Yekutieli or Bonferroni."""
...
def correlate(
	...
	:param correlation_method: Correlation method to compute (Person, Spearman or Kendall)
	...
	:param adjustment_method: P-value adjustment method (Benjamini-Hochberg, Benjamini-Yekutieli or Bonferroni)
