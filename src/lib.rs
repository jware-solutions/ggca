...
pub trait Computation {
    fn all_vs_all(
        ...
        println!(
            "Numero total de combinaciones a evaluar -> {}",
    ...
    fn get_df(&self, path: &str) -> Matrix {
...
// struct ExperimentFromBatches;

pub fn new_from_files(file_1_path: String, file_2_path: String) -> impl Computation {
    ExperimentFromFiles {
        file_1_path,
        file_2_path,
    }
